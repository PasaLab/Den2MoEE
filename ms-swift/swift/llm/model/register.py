...
from swift.llm.model.den2moee.configuration_den2moee import den2moeeConfig
from swift.llm.model.den2moee.modeling_den2moee import den2moeeForCausalLM, den2moeeModel, den2moeePreTrainedModel, den2moeeSparseMoeBlock, den2moeeTopkRouter, den2moeeMLP
...
def get_model_info_meta(
    ...
    if model_type is not None:
        ...
        print("\n\n\n\n\n\n")
        print(f"MODEL_MAPPING length: {len(MODEL_MAPPING)}")
        print("\n\n\n\n\n\n")
...
def get_model_tokenizer(
    ...
    print()
    print(f"model_meta: {model_meta}")
    print(f"model_meta get_function: {model_meta.get_function}")
    print("\n\n\n\n\n\n\n")
